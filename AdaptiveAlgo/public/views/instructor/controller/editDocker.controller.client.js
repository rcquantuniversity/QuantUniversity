(function () {
    ...
    .controller("EditDockerController", function($scope, $http, UserService, $location, $window, Upload, $timeout) {
            ...
            UserService
                ...
                .then(
                    function (obj) {
                        ...
                        buildDocker(allPackageArray, imageName, description, moduleName, duration, imageType, extractLocation);
                    },
                    function (err) {
                        console.log(err);
                        buildDocker(allPackageArray, imageName, description, moduleName, duration, imageType, extractLocation);
        ...
        function buildDocker(allPackageArray, imageName, description, moduleName, duration, imageType, extractLocation) {
                    ...
                    function (imageName) {
                        ...
                        UserService
                            .createDockerImage(imageName.data.replace('"','').replace('"',''),
                                allPackageArray, description, moduleName, duration, imageType, extractLocation)
                            .then(
                                function (status) {
