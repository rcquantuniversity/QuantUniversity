(function () {
    ...
    .controller("BuildDockerController", function($scope, $http, UserService, $location, $window, Upload, $timeout) {
        ...
        function createDockerImage(folder1, folder2, folder3, imageName, description, imageType) {
            ...
            UserService
                ...
                .then(
                    function (obj) {
                        ...
                        buildDocker(allPackageArray, imageName, description, imageType);
                    },
                    function (err) {
                        console.log(err);
                        buildDocker(allPackageArray, imageName, description, imageType);
        ...
        function buildDocker(allPackageArray, imageName, description, imageType) {
            UserService
                ...
                .then(
                    function (imageName) {
                        ...
                        UserService
                            .createDockerImage(imageName.data.replace('"','').replace('"',''), allPackageArray, description, imageType)
                            .then(
                                function (status) {
