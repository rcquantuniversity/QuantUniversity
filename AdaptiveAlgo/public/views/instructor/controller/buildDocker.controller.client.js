(function () {
    ...
    .controller("BuildDockerController", function($scope, $http, UserService, $location, $window, Upload, $timeout) {
        ...
        function createDockerImage(folder1, folder2, folder3, imageName, imageType) {
            ...
            UserService
                ...
                .then(
                    function (obj) {
                        ...
                        buildDocker(allPackageArray, imageName, imageType);
                    },
                    function (err) {
                        console.log(err);
                        buildDocker(allPackageArray, imageName, imageType);
        ...
        function buildDocker(allPackageArray, imageName, imageType) {
            UserService
                ...
                .then(
                    function (imageName) {
                        ...
                        UserService
                            .createDockerImage(imageName.data.replace('"','').replace('"',''), allPackageArray, imageType)
                            .then(
                                function (status) {
